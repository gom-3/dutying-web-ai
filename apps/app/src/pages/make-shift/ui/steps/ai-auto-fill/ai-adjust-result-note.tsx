import type {TAutofillResponse, TScheduleRequestRuleResult} from '@dutying/api/ward';
 ...
 */
export default function AiAdjustResultNote({changedCount, ruleResults, offGoal, isStrongest, disabled, onAdjustHarder}: TProps) {
