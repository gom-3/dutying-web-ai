...
export const ANDROID_PLAY_STORE_URL_JA = 'https://play.google.com/store/apps/details?id=ai.dutying.app&hl=ja&gl=JP';
export const ANDROID_PLAY_STORE_URL_KO = 'https://play.google.com/store/apps/details?id=ai.dutying.app&hl=ko&gl=KR';
export const ANDROID_PLAY_STORE_URL_DEFAULT = 'https://play.google.com/store/apps/details?id=ai.dutying.app&hl=en&gl=US';
export const ANDROID_PLAY_STORE_URL = ANDROID_PLAY_STORE_URL_DEFAULT;
...
export const resolveAndroidPlayStoreUrl = (languages: readonly string[]) => {
    const normalizedLanguages = languages.map((language) => language.toLowerCase());
