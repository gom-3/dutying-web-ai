...
export const en: TLocale = {
    page: {
        ...
        makeShift: {
            ...
            calendar: {
                ...
                fixCell: 'Fix',
                unfixCell: 'Unfix',
                fixCellSuccess: 'Shift fixed.',
                unfixCellSuccess: 'Shift unfixed.',
                clearCell: 'Clear',
            ...
            fixedShifts: {
                ...
                lockedToast: 'Unfix this shift before editing it.',
            ...
            aiRefill: {
                ...
                toolbarSubTitle: 'Fix any shifts AI should not change before autofill.',
                ...
                adjust: {
                    ...
                    examples: {
                        clusterOn: 'Group my shifts together and keep two days off in a row',
                        clusterOff: 'Shorten the work streaks and spread the days off out',
                        offBalance: 'Make the number of days off more equal between nurses',
                        seniorityMix: 'Mix experience levels so new nurses are not stacked on one shift',
                        maxConsecutiveDay: 'At most 4 day shifts in a row',
                        maxConsecutiveNight: 'At most 3 night shifts in a row',
                        maxConsecutiveWork: 'At most 5 work days in a row, then a day off',
                        offAfterNight: 'Two days off after a run of nights',
                        noIsolatedOff: 'No single days off, keep at least two together',
                        forbidNightThenDay: 'No day shift the morning after a night shift',
                        forbidEveningThenDay: 'Avoid a day shift right after an evening shift',
                        monthlyNightCap: 'At most 6 night shifts per nurse this month',
                        weekendCap: 'At most 3 weekend shifts per nurse',
                    ...
                    textInput: {
                        ...
                        placeholder: 'e.g. Make days off more even, and group shifts together',
                        submit: 'Adjust',
                        interpreting: 'Reading…',
                    },
                    interpretFailed: 'Could not read the sentence. Please try again shortly.',
                    lifetime: {
                    ...
                    card: {
                        ...
                        empty: 'Could not map this to an adjustment. Try phrasing it around days off, grouping shifts, or experience mix.',
                        lifetimeLabel: '{{label}} lifetime',
                        teamHint: 'Sounds like something to keep',
                        assumedBadge: 'Default',
                        assumedTooltip: 'You did not give a number, so we picked one. Say it again to change it.',
                        cellApplied: 'Set and pinned {{count}} cell(s)',
                        cellNotApplied: 'Could not find that cell in the table',
                        ruleNote: 'This can become a rule — it is not applied in this adjustment.',
                        apply: 'Apply',
                        cancel: 'Cancel',
                    },
                    requests: {
                    ...
                    carryOver: {
                        title: 'Last month had these requests',
                        description: 'Choose the ones to keep for this month.',
                        yes: 'This month too',
                        no: 'No',
                        apply: 'Apply',
                        skip: 'Skip',
                        applied: 'Brought {{count}} requests into this month.',
                        failed: 'Could not bring them over. Please try again shortly.',
                    },
                },
                ...
                lastShiftBlankDialog: {
                    ...
                    description: 'Some previous-shift cells are empty. Fill them if AI should consider continuity from the prior month.',
        ...
        onboardingWardCreate: {
            ...
            rotation: {
                ...
                mixedTitle: 'Mostly three-shift, sometimes two-shift',
        ...
        wardSettings: {
            ...
            shiftTypes: {
                ...
                rotation: {
                    ...
                    modeDescription:
                        'Choose the option closest to how your ward operates. We will prepare the matching standard shift types.',
                    threeTitle: 'Three-shift only',
                    threeDescription: 'Use day, evening, and night shifts.',
                    twoTitle: 'Two-shift only',
                    twoDescription: 'Use two-shift day (07–19) and night (19–07).',
                    mixedTitle: 'Mostly three-shift, sometimes two-shift',
                    mixedDescription: 'Use day, evening, and night by default, with two-shift day and night when needed.',
    ...
    widget: {
        ...
        wardChat: {
            ...
            photoPreview: 'Sent a photo.',
            addImageAria: 'Add photo',
            addImageTitle: 'Add photo',
            removeImageAria: 'Remove {{name}} photo',
            removeImageTitle: 'Remove photo',
            imageUploadingAria: 'Uploading photo',
            imagePreviewAria: 'Preview photo {{index}} of {{total}}',
            imagePreviewTitle: 'Photo preview',
            closeImagePreviewAria: 'Close photo preview',
            imageFallbackName: 'Photo',
            state: {
            ...
            toast: {
                ...
                imageUploadFailed: 'Could not upload the photo. Please try again.',
                maxImageCount: 'You can send up to {{count}} photos.',
                maxImageSize: 'Images must be {{size}}MB or smaller.',
