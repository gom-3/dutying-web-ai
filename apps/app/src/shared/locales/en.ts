    ...
    page: {
        ...
        makeShift: {
            ...
            aiRefill: {
                ...
                prefillDecision: {
                    title: 'How should these entered shifts be handled?',
                    description:
                        'Before the first AI autofill, there are {{count}} entered shifts that are not fixed.\nIf they must stay, fix them before filling. If they are only a draft, clear them and generate a fresh schedule.',
                    confirm: 'Fix and fill',
                    cancel: 'Clear and generate',
                },
                regenerateDecision: {
                ...
                exitGuard: {
                    unsavedMessage: 'Your edits may not be saved.\nSave a draft or confirm first.\nLeave anyway?',
