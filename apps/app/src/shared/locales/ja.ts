    ...
    page: {
        ...
        onboardingJoinWard: {
            ...
            permission: {
                ...
                description:
                    '病棟コードは確認できましたが、現在のアカウントには管理者権限がありません。最高管理者（オーナー）が現在のアカウントのメールアドレスを管理者として登録しておく必要があります。',
                descriptionWithWard:
                    '病棟コードは確認できましたが、現在のアカウントには管理者権限がありません。{{hospitalName}} {{wardName}}の最高管理者（オーナー）が現在のアカウントのメールアドレスを管理者として登録しておく必要があります。',
                close: '閉じる',
                confirm: '確認',
            },
            toast: {
        ...
        shiftEditor: {
            ...
            validation: {
                ...
                minProficiencyStaffByShift:
                    '{{shift}}勤務のLV{{level}}以上の看護師は{{actual}}人です。最低{{expected}}人必要です。',
