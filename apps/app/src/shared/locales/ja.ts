...
export const ja: TLocale = {
    ...
    page: {
        ...
        wardSettings: {
            ...
            description: {
                ...
                calendar: en.page.wardSettings.description.calendar,
            ...
            tabs: {
                ...
                calendar: en.page.wardSettings.tabs.calendar,
                constraints: '制約条件',
            },
            addShiftType: '勤務を追加',
            type: {
        ...
        member: {
            ...
            detail: {
                ...
                shiftRatio: '月間勤務比率',
                shiftRatioHelpAria: '月間勤務比率の案内',
                shiftRatioHint: 'D/E/N/Oの可能勤務を基準に月間目標日数を調整します',
                shiftRatioEmpty: 'D/E/N/Oの可能勤務を選択すると比率を設定できます',
                shiftRatioInputAria: '{{shiftName}}の月間勤務日数',
                shiftRatioReset: '月間勤務比率を開く',
                memo: 'メモ',
        ...
        makeShift: {
            ...
            calendar: {
                ...
                fixCell: '固定する',
                unfixCell: '固定を解除する',
                fixCellSuccess: '勤務を固定しました。',
                unfixCellSuccess: '勤務の固定を解除しました。',
                clearCell: 'クリア',
            ...
            aiRefill: {
                ...
                adjust: {
                    ...
                    examples: {
                        clusterOn: '勤務をまとめて続けて、オフも2日ずつ続けてください',
                        clusterOff: '連続勤務を減らしてオフをこまめに入れてください',
                        offBalance: 'オフの数を看護師ごとにもっと公平にしてください',
                        seniorityMix: '1つの勤務に新人が偏らないよう習熟度を混ぜてください',
                        maxConsecutiveDay: '日勤は4日連続まで',
                        maxConsecutiveNight: '夜勤は3日連続まで',
                        maxConsecutiveWork: '勤務は5日連続までで、その後は休ませてください',
                        offAfterNight: '夜勤の後は2日休ませてください',
                        noIsolatedOff: 'オフを1日ずつに分けず2日以上つなげてください',
                        forbidNightThenDay: '夜勤の翌日に日勤は入れないでください',
                        forbidEveningThenDay: '準夜の翌日の日勤は避けてください',
                        monthlyNightCap: '夜勤は1か月に1人6回まで',
                        weekendCap: '週末勤務は1人3回まで',
                    ...
                    monthRuleBadge: '今月のルール',
                    remaining: '「{{label}}」が{{count}}か所残っています。',
                    remainingAction: 'もっと強く調整',
                    ...
                    textInput: {
                        label: '調整リクエスト',
                        placeholder: '例: 休みをもっと均等に、勤務はまとめて',
                        submit: '調整',
                        interpreting: '読み取り中…',
                    },
                    interpretFailed: '文章を読み取れませんでした。しばらくしてからもう一度お試しください。',
                    lifetime: {
                        MONTH: '今月のみ',
                        TEAM: '継続',
                    },
                    card: {
                        title: 'このように理解しました',
                        empty: '調整に変換できませんでした。休み・勤務のまとめ・経験レベルのように書いてみてください。',
                        lifetimeLabel: '{{label}} の期間',
                        teamHint: '継続して使いそうです',
                        assumedBadge: '既定値',
                        assumedTooltip: '数値の指定がなかったので、こちらで選びました。違う場合はもう一度お伝えください。',
                        cellApplied: '{{count}}マスを表に反映して固定しました',
                        cellNotApplied: '表でそのマスを見つけられませんでした',
                        ruleNote: 'ルールにできます — 今回の調整には適用されません。',
                        apply: '適用する',
                        cancel: 'キャンセル',
                    },
                    requests: {
                    ...
                    carryOver: {
                        title: '先月はこんなリクエストがありました',
                        description: '今月も残すリクエストを選んでください。',
                        yes: '今月も',
                        no: 'いいえ',
                        apply: '適用',
                        skip: 'スキップ',
                        applied: '{{count}}件を今月に引き継ぎました。',
                        failed: '引き継げませんでした。しばらくしてからもう一度お試しください。',
                    },
                },
                undo: '元に戻す',
                redo: 'やり直す',
    ...
    widget: {
        ...
        wardChat: {
            ...
            enableAlertAria: '病棟トークの新着メッセージ通知をオンにする',
            disableAlertAria: '病棟トークの新着メッセージ通知をオフにする',
            alertOnTooltip: '新着メッセージ通知オン',
            alertOffTooltip: '新着メッセージ通知オフ',
            previewOpenAria: '{{sender}}さんからの新着メッセージを開く: {{text}}',
            unknownSender: '病棟トーク',
            emptyPreview: '新しいメッセージが届きました。',
            photoPreview: '写真を送信しました。',
            addImageAria: '写真を追加',
            addImageTitle: '写真を追加',
            removeImageAria: '{{name}}の写真を削除',
            removeImageTitle: '写真を削除',
            imageUploadingAria: '写真をアップロード中',
            imagePreviewAria: '写真{{index}}/{{total}}をプレビュー',
            imagePreviewTitle: '写真プレビュー',
            closeImagePreviewAria: '写真プレビューを閉じる',
            imageFallbackName: '写真',
            state: {
            ...
            toast: {
                ...
                maxImageCount: '写真は最大{{count}}枚まで送信できます。',
                maxImageSize: '画像ファイルは{{size}}MB以下のみアップロードできます。',
