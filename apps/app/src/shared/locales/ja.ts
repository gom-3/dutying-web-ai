    ...
    page: {
        ...
        onboardingJoinWard: {
            ...
            permission: {
                ...
                description:
                    '病棟コードは確認できましたが、現在のアカウントには管理者権限がありません。オーナーが現在のアカウントのメールアドレスを管理者として登録しておく必要があります。',
                descriptionWithWard:
                    '病棟コードは確認できましたが、現在のアカウントには管理者権限がありません。{{hospitalName}} {{wardName}}のオーナーが現在のアカウントのメールアドレスを管理者として登録しておく必要があります。',
                close: '閉じる',
                confirm: '確認',
            },
            toast: {
