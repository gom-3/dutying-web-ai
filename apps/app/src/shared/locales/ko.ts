    ...
    page: {
        ...
        makeShift: {
            ...
            tutorial: {
                ...
                authoringFixed: {
                    title: '바꾸면 안 되는 근무 고정하기',
                    info: '근무표 작성 화면에서도 셀을 선택해 고정할 수 있어요.\n고정한 근무와 신청근무는 AI가 자동채우기 때 바꾸지 않아요.',
                },
                aiAutofill: {
                    title: 'AI 자동 채우기',
            ...
            aiRefill: {
                ...
                prefillDecision: {
                    title: '입력해 둔 근무를 어떻게 할까요?',
                    description:
                        '아직 AI 자동채우기 전인데, 고정하지 않은 작성 근무가 {{count}}칸 있어요.\n유지해야 하는 근무라면 고정하고 채우고, 초안이라면 비우고 새로 생성해 주세요.',
                    confirm: '고정하고 채우기',
                    cancel: '비우고 새로 생성',
                },
                regenerateDecision: {
