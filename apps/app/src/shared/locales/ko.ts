export const ko = {
    page: {
        ...
        makeShift: {
            ...
            calendar: {
                ...
                fixCell: '고정하기',
                unfixCell: '고정해제하기',
                fixCellSuccess: '근무를 고정했어요.',
                unfixCellSuccess: '근무 고정을 해제했어요.',
                clearCell: '비우기',
            ...
            aiRefill: {
                ...
                toolbarSubTitle: 'AI가 바꾸면 안 되는 근무는 먼저 고정해 주세요.',
                ...
                adjust: {
                    ...
                    // 예시는 누르면 입력창에 채워질 뿐 바로 실행되지 않는다. 사용자가 숫자·이름·근무를
                    // 고친 뒤 "조절"을 누른다. 설계서 5단계 §6.2 표가 정본이며, 문장을 바꾸면
                    // llm-server 골든 테스트도 같이 바꾼다.
                    examples: {
                        clusterOn: '근무를 몰아서 연달아 하고, 오프도 이틀씩 붙여줘',
                        clusterOff: '연속 근무를 줄이고 오프를 자주 넣어줘',
                        offBalance: '오프 개수를 사람마다 더 공평하게',
                        seniorityMix: '한 근무에 신입만 몰리지 않게 숙련도를 섞어줘',
                        maxConsecutiveDay: '데이는 4일 연속까지만',
                        maxConsecutiveNight: '나이트는 3일 연속까지만',
                        maxConsecutiveWork: '근무는 5일 연속까지만 하고 그다음엔 쉬게',
                        offAfterNight: '나이트 끝나면 이틀은 쉬게 해줘',
                        noIsolatedOff: '오프를 하루씩 쪼개지 말고 이틀 이상 붙여줘',
                        forbidNightThenDay: '나이트 다음 날 데이는 넣지 마',
                        forbidEveningThenDay: '이브닝 다음 날 데이는 피해줘',
                        monthlyNightCap: '나이트는 한 달에 사람당 6번까지만',
                        weekendCap: '주말 근무는 사람마다 3번 이하로',
                    ...
                    textInput: {
                        label: '조절 요청 문장',
                        placeholder: '예: 오프 좀 더 공평하게 하고, 근무는 붙여줘',
                        submit: '조절',
                        interpreting: '이해하는 중…',
                    },
                    interpretFailed: '문장을 이해하지 못했어요. 잠시 후 다시 시도해 주세요.',
                    lifetime: {
                        MONTH: '이번 달만',
                        TEAM: '계속',
                    },
                    ...
                    carryOver: {
                        title: '지난달에 이런 요청이 있었어요',
                        description: '이번 달에도 걸어 둘 요청을 골라 주세요.',
                        yes: '이번 달도',
                        no: '아니요',
                        apply: '적용',
                        skip: '건너뛰기',
                        applied: '{{count}}건을 이번 달로 가져왔어요.',
                        failed: '가져오지 못했어요. 잠시 후 다시 시도해 주세요.',
                    },
                },
        ...
        wardSettings: {
            ...
            shiftTypes: {
                ...
                rotation: {
                    ...
                    modeDescription: '가장 가까운 운영 방식을 하나 선택해 주세요. 선택에 맞춰 표준 근무유형을 준비해요.',
                    threeTitle: '3교대만 운영해요',
    ...
    widget: {
        ...
        wardChat: {
            ...
            photoPreview: '사진을 보냈습니다.',
            addImageAria: '사진 추가',
            addImageTitle: '사진 추가',
            removeImageAria: '{{name}} 사진 삭제',
            removeImageTitle: '사진 삭제',
            imageUploadingAria: '사진 업로드 중',
            imagePreviewAria: '사진 {{index}}/{{total}} 미리보기',
            imagePreviewTitle: '사진 미리보기',
            closeImagePreviewAria: '사진 미리보기 닫기',
            imageFallbackName: '사진',
            state: {
            ...
            toast: {
                ...
                imageUploadFailed: '사진 업로드에 실패했어요. 다시 시도해 주세요.',
                maxImageCount: '사진은 최대 {{count}}장까지 보낼 수 있어요.',
                maxImageSize: '이미지 파일은 {{size}}MB 이하만 업로드할 수 있어요.',
                imageOnly: '이미지 파일만 업로드할 수 있어요.',
            },
        },
    },
    feature: {
