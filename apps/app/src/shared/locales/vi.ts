        ...
        makeShift: {
            ...
            aiRefill: {
                ...
                adjust: {
                    ...
                    examples: {
                        clusterOn: 'Xếp các ca liền nhau và cho nghỉ hai ngày liên tiếp',
                        clusterOff: 'Giảm số ngày làm liên tiếp và chia ngày nghỉ ra',
                        offBalance: 'Cho số ngày nghỉ giữa các điều dưỡng đều hơn',
                        seniorityMix: 'Đừng dồn điều dưỡng mới vào một ca, hãy trộn kinh nghiệm',
                        maxConsecutiveDay: 'Ca ngày tối đa 4 ngày liên tiếp',
                        maxConsecutiveNight: 'Ca đêm tối đa 3 ngày liên tiếp',
                        maxConsecutiveWork: 'Làm tối đa 5 ngày liên tiếp rồi cho nghỉ',
                        offAfterNight: 'Sau đợt ca đêm cho nghỉ hai ngày',
                        noIsolatedOff: 'Đừng nghỉ lẻ một ngày, hãy cho nghỉ ít nhất hai ngày liền',
                        forbidNightThenDay: 'Không xếp ca ngày ngay sau ca đêm',
                        forbidEveningThenDay: 'Tránh ca ngày ngay sau ca chiều',
                        monthlyNightCap: 'Mỗi người tối đa 6 ca đêm trong tháng',
                        weekendCap: 'Mỗi người tối đa 3 ca cuối tuần',
                    ...
                    textInput: {
                        ...
                        placeholder: 'VD: Ngày nghỉ đều hơn, và gom ca lại',
                        submit: 'Điều chỉnh',
                        interpreting: 'Đang đọc…',
                    },
                    interpretFailed: 'Không hiểu được câu này. Vui lòng thử lại sau.',
                    lifetime: {
                        MONTH: 'Chỉ tháng này',
                        TEAM: 'Giữ lại',
                    },
                    card: {
                        title: 'Chúng tôi hiểu như sau',
                        empty: 'Không chuyển được thành hướng điều chỉnh. Hãy thử nói về ngày nghỉ, gom ca hoặc kinh nghiệm.',
                        lifetimeLabel: 'Thời hạn của {{label}}',
                        teamHint: 'Có vẻ sẽ dùng lâu dài',
                        assumedBadge: 'Mặc định',
                        assumedTooltip: 'Bạn chưa cho số nên chúng tôi chọn giúp. Nếu khác, hãy nói lại.',
                        cellApplied: 'Đã đặt và ghim {{count}} ô trong bảng',
                        cellNotApplied: 'Không tìm thấy ô đó trong bảng',
                        ruleNote: 'Có thể tạo thành quy tắc — không áp dụng trong lần điều chỉnh này.',
                        apply: 'Áp dụng',
                        cancel: 'Hủy',
                    },
                    requests: {
                    ...
                    carryOver: {
                        title: 'Tháng trước có những yêu cầu này',
                        description: 'Chọn yêu cầu muốn giữ cho tháng này.',
                        yes: 'Tháng này cũng vậy',
                        no: 'Không',
                        apply: 'Áp dụng',
                        skip: 'Bỏ qua',
                        applied: 'Đã đưa {{count}} yêu cầu vào tháng này.',
                        failed: 'Không đưa vào được. Vui lòng thử lại sau.',
                    },
                },
            },
            calendar: {
