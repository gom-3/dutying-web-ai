...
export const TutorialOverlay = ({config, closeCallback}: ITutorialOverlayProps) => {
    ...
    }, [calculateInfoBoxPosition, config.steps]);
    /**
    ...
    }, [config.scrollLock, setHighlightedElementPositions]);

    return (
        <>
            <div id="TutorialOverlay" className="fixed top-0 left-0 z-998 h-screen w-screen bg-[#00000020]" ref={overlayElement}></div>
            <div
                id="InfoBox"
